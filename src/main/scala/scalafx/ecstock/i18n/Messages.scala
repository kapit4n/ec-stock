...
object Messages {
  ...
  data += ("dolars" -> "Bolivianos")
  data += ("prices" -> "Precios")
  data += ("costs" -> "Costos")
  data += ("revenues" -> "Ganancias")
  ...
  data += ("Report Customer" -> "Ventas por Cliente")
  data += ("Report Finance" -> "Reporte de Ganancias")
  data += ("Report Price Vs Cost" -> "Reporte Precios vs Costos")
  ...
  dataOpposite += ("Ventas por Cliente" -> "Report Customer")
  dataOpposite += ("Reporte de Ganancias" -> "Report Finance")
  dataOpposite += ("Reporte Precios vs Costos" -> "Report Price Vs Cost")
