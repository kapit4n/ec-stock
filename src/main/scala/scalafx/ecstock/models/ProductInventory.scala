...
class ProductInventory(idParam: Int, val product: Int, val vendor: Int, val quantity: Long, val unitCost: Double, val totalCost: Double, productName: String, vendorName: String) {
  @Id
